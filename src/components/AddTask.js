...
const AddTask = () => {
    ...
    const handleTask = e => {
        ...
        fetch('https://task-manager-server-nu.vercel.app/addtask', {
            method: 'POST',
            headers: {
